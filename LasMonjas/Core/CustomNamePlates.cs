...
namespace LasMonjas.Core
{
    ...
    public class CustomPlate
    {
        ...
        public static List<AuthorData> authorDatas = new List<AuthorData>()
        {
            ...
            new AuthorData {AuthorName = "Muaresito", NamePlateName = "Typical Ragder of Rubianes"},
        ...
        public static readonly Dictionary<string, TempPlateViewData> CustomNameplateViewDatas = [];
            ...
            public static void Postfix(HatManager __instance) {
                ...
                foreach (var file in authorDatas) {
                    try {
                        ...
                        CustomNameplateViewDatas.TryAdd(plate.ProductId, tpvd);
                    }
                    catch {
                    }
                }
