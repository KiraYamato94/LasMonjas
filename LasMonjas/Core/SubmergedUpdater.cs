...
namespace LasMonjas.Core 
{
    ...
    {
        // Borrowed from The Other Roles to make people able to update Submerged easier
        ...
        [HideFromIl2Cpp]
        public UpdateData RequiredUpdateData => SubmergedUpdate;
        ...
        {
            if (TryUpdateSubmergedInternally()) return true;
            var data = SubmergedUpdate;
            ...
            string filePath = Path.Combine(Paths.PluginPath, "Submerged.dll");
