        ...
        public static class ChatCommandsInfo
        {
            ...
            private static class SendChatPatch
            {
                ...
                static bool Prefix(ChatController __instance) {
                    string text = HudManager.Instance.Chat.freeChatField.textArea.text;
                    ...
                    if (handled) {
                        HudManager.Instance.Chat.freeChatField.textArea.Clear();
                        HudManager.Instance.Chat.quickChatMenu.Clear();
                    }
                    return !handled;
                }
            }
